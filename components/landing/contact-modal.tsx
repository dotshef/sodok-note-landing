...
const DEFAULT_TRIGGER_CLASS =
  "inline-flex items-center justify-center rounded-lg border border-white/20 bg-white/10 px-[22px] py-3 text-[16px] font-semibold text-white transition-colors hover:bg-white/[0.18] active:scale-[0.97]";

export function ContactModal({
  triggerLabel = "1:1 문의하기",
